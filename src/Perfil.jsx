...
import { User, Mail, Shield, BarChart2, CheckCircle, XCircle, Clock, AlertCircle } from 'lucide-react';
                ...
                <div className="px-8 pb-8">
                    <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6 -mt-16">
                        <div className="flex items-end gap-6">
                            ...
                            <div className="mb-2">
                                <h1 className="text-3xl font-bold text-slate-900 mb-1">{currentUser.nombre}</h1>
